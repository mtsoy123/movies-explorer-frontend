  ...
  return (
    <section className='about-me'>
      ...
      <div className='about-me__container'>
        ...
        <p className='about-me__body'>Я родился и вырос в Санкт-Петербурге. Окончил Петербургский университет телекоммуникаций. Начал путь в айти дизайнером интерфейсов. Сейчас глаза горят разработкой. В свободное время я mindfulness samurai. Медитирую и практикую осознанность.</p>
        ...
        <div className='about-me__social-link-container'>
          ...
          <a href='https://www.linkedin.com/in/mikhail-tsoy/' className='about-me__social-link'>Linkedin</a>
